      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-16 md:pt-24 xl:pt-32">
        <h1 className="relative font-space-grotesk text-4xl md:text-6xl font-bold mb-1">
          <span className="relative inline-block">
            ...
            <h1 className="text-4xl sm:text-6xl  max-w-[450px] md:max-w-[560px] 3xl:max-w-screen-sm !leading-[1.2] font-extrabold tracking-widest relative bg-clip-text text-transparent bg-gradient-to-r from-white via-[#E2E4FF] to-[#B4B7E5]">
                 KAIROS
            </h1>
          </span>
        </h1>
         <h2 className="!text-sm sm:!text-base !font-normal text-[#E2E4FF] max-w-[300px] sm:max-w-full">The ultimate boss tracking tool for any MMORPG</h2>
