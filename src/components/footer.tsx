    ...
    <LinearLoading isLoading={isPending} />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="flex justify-center space-x-8 mb-12">
            <span onClick={()=> handleNavigate("/features")} className="text-[#B4B7E5] hover:text-white transition-colors duration-200 text-sm cursor-pointer">
              Features
            </span>
            <span onClick={()=> handleNavigate("/guide")} className="text-[#B4B7E5] hover:text-white transition-colors duration-200 text-sm cursor-pointer">
              Guide
            </span>
            <span onClick={()=> handleNavigate("/about")} className="text-[#B4B7E5] hover:text-white transition-colors duration-200 text-sm cursor-pointer">
              About
            </span>
          </div>
